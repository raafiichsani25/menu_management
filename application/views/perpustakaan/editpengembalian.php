                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                     ...
                     $siswa_id = $this->db->get_where('siswa',['id' => $pengembalian['siswa_id']])->row_array(); 

                        $buku_id = $this->db->get_where('buku',['id' => $pengembalian['buku_id']])->row_array();
                     ...
                     ?>
                        ...
                        <div class="col-sm-10">
                         ...
                         <option value="<?= $buku_id['id']?>"><?= $buku_id['judul'];?></option>
                            ...
                            <div class="col-sm-10">
                              <input type="text" class="form-control" id="tanggal_pinjam" name="tanggal_pinjam" value=" <?= date('d F Y ',$pengembalian['tanggal_pinjam']); ?>" readonly>
                  ...
                  <label for="tanggal_pengembalian" class="col-sm-2 col-form-label">Tanggal Kembali</label>
                            <div class="col-sm-10">
                              <input type="text" class="form-control datepicker" id="tanggal_pengembalian" name="tanggal_pengembalian" value="<?= $pengembalian['tanggal_pengembalian'];?>">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                              <input type="text" class="form-control" id="keteragan" name="keterangan" value="<?= $pengembalian['keterangan'];?>">
