...
<hr>
     <h4>Total Peminjaman Buku : <?= $total_rows; ?></h4>
     <table border="3" cellspacing="3" cellpadding="3">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td align="center"><?= $pm['judul']; ?></td>

                                  <td align="center"><?= date('d F Y ',$pm['tanggal_pinjam']);?></td>

                                  <td align="center"><?= date('d F Y ',$pm['tanggal_pengembalian']);?></td>

                                  <td align="center"><?= $pm['keterangan']; ?></td>
